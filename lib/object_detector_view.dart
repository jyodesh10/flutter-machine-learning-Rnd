...
class _ObjectDetectorView extends State<ObjectDetectorView> {
  ...
  final _options = {
    'default': '',
    'object_custom': 'mnasnet_1.3_224_1_metadata_1.tflite',
    ...
    'landmarks': 'lite-model_on_device_vision_classifier_landmarks_classifier_europe_V1_1.tflite',
  ...
  void _initializeDetector() async {
    ...
    if (_option == 0) {
      ...
      final modelPath = await getAssetPath('asset/$option');
